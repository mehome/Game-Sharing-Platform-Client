...
CCollectCamera::CCollectCamera(CString devicename)
{
	...
	//strncpy_s(this->devicename,"vedio=Lenovo EasyCamera",20);
}
...
//Windows
	...
	if(!(this->ifmt=av_find_input_format("dshow")))
	{
		return ;
	...
	screen = SDL_CreateWindowFrom((void *)((CMyDlgMain *)theApp.m_pMainWnd)->dlg_pc->m_picture.GetSafeHwnd());
